...
public class Difficulty extends AbstractPropertiesCommand {
    ...
    public Difficulty() {
        super(
                Parameter.registryElement(TypeToken.get(org.spongepowered.api.world.difficulty.Difficulty.class), RegistryTypes.DIFFICULTY)
    ...
    protected void run(final Audience src, final CommandContext context, final ServerWorldProperties properties) throws CommandException {
        final Optional<org.spongepowered.api.world.difficulty.Difficulty> optionalInput = context.getOne(CosmosKeys.DIFFICULTY);
