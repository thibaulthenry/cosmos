...
public class GameMode extends AbstractPropertiesCommand {
    ...
    public GameMode() {
        super(
                Parameter.registryElement(TypeToken.get(org.spongepowered.api.entity.living.player.gamemode.GameMode.class), RegistryTypes.GAME_MODE)
    ...
    protected void run(final Audience src, final CommandContext context, final ServerWorldProperties properties) throws CommandException {
        final Optional<org.spongepowered.api.entity.living.player.gamemode.GameMode> optionalInput = context.getOne(CosmosKeys.GAME_MODE);
