...
public class CosmosKeys {
    ...
    public static final Parameter.Key<Component> PLAYER_NAME = Parameter.key("player", Component.class);
    ...
    public static final Parameter.Key<Component> TRACKED = Parameter.key("tracked", Component.class);
