...
public class CosmosPressurePlatePortalImpl extends AbstractCosmosPortal implements CosmosPressurePlatePortal {

    public CosmosPressurePlatePortalImpl(final ResourceKey key, final Set<ServerLocation> origins, final BlockType trigger,
        ...
        super(
                key, origins, trigger, CosmosPortalTypes.PRESSURE_PLATE.get(),
