...
public class CosmosSignPortalImpl extends AbstractCosmosPortal implements CosmosSignPortal {
    ...
    public CosmosSignPortalImpl(final ResourceKey key, final Set<ServerLocation> origins, final BlockType trigger,
        ...
        super(
                key, origins, trigger, CosmosPortalTypes.SIGN.get(),
