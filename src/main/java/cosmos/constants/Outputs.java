...
public enum Outputs {
    ...
    USAGE_PER_WORLD_BYPASS(TextColors.GREEN, "cm perworld <{{6}}> bypass [<{{6}}>] [<{{6}}>]"),
    USAGE_PER_WORLD_GROUP(TextColors.GREEN, "cm perworld <{{6}}> group <{{6}}...>"),
    USAGE_PER_WORLD_INFORMATION(TextColors.GREEN, "cm perworld <{{6}}> information"),
    USAGE_PER_WORLD_TOGGLE(TextColors.GREEN, "cm perworld <{{6}}> toggle [<{{6}}>] [<{{6}}>]"),
    ...
    USAGE_PROPERTIES_ENABLE_STRUCTURES(TextColors.GREEN, "cm properties [<{{2}}>] enablestructures [<{{6}}>]"),
    ...
    USAGE_PROPERTIES_SEED(TextColors.GREEN, "cm properties [<{{2}}>] seed [<{{6}}>]"),
    ...
    EX_PER_WORLD_BYPASS_0(TextColors.GREEN, "cm perworld {{6}} bypass"),
    EX_PER_WORLD_BYPASS_1(TextColors.GREEN, "cm perworld {{6}} bypass {{6}}"),
    EX_PER_WORLD_BYPASS_2(TextColors.GREEN, "cm perworld {{6}} bypass {{6}} {{6}}"),
    EX_PER_WORLD_BYPASS_3(TextColors.GREEN, "cm perworld {{6}} bypass {{6}} {{6}}"),
    EX_PER_WORLD_GROUP_0(TextColors.GREEN, "cm perworld {{6}} group {{2}} {{2}} {{2}}"),
    EX_PER_WORLD_GROUP_1(TextColors.GREEN, "cm perworld {{6}} group {{2}}"),
    EX_PER_WORLD_GROUP_2(TextColors.GREEN, "cm perworld {{6}} group {{2}} {{2}}"),
    EX_PER_WORLD_INFORMATION_0(TextColors.GREEN, "cm perworld {{6}} information"),
    EX_PER_WORLD_INFORMATION_1(TextColors.GREEN, "cm perworld {{6}} info"),
    EX_PER_WORLD_TOGGLE_0(TextColors.GREEN, "cm perworld {{6}} toggle {{6}}"),
    EX_PER_WORLD_TOGGLE_1(TextColors.GREEN, "cm perworld {{6}} toggle {{6}}"),
    EX_PER_WORLD_TOGGLE_2(TextColors.GREEN, "cm perworld {{6}} toggle {{6}} {{6}}"),
    EX_PER_WORLD_TOGGLE_3(TextColors.GREEN, "cm perworld {{6}} toggle"),
    EX_PER_WORLD_TOGGLE_4(TextColors.GREEN, "cm perworld {{6}} toggle {{6}}"),
    ...
    EX_PROPERTIES_ENABLE_STRUCTURES_0(TextColors.GREEN, "cm properties {{2}} enablestructures {{6}}"),
    EX_PROPERTIES_ENABLE_STRUCTURES_1(TextColors.GREEN, "cm properties enablestructures {{6}}"),
    EX_PROPERTIES_ENABLE_STRUCTURES_2(TextColors.GREEN, "cm properties {{2}} enablestructures"),
    EX_PROPERTIES_ENABLE_STRUCTURES_3(TextColors.GREEN, "cm properties enablestructures"),
    ...
    EX_PROPERTIES_SEED_0(TextColors.GREEN, "cm properties {{2}} seed {{6}}"),
    EX_PROPERTIES_SEED_1(TextColors.GREEN, "cm properties seed {{6}}"),
    EX_PROPERTIES_SEED_2(TextColors.GREEN, "cm properties {{2}} seed"),
    EX_PROPERTIES_SEED_3(TextColors.GREEN, "cm properties seed"),
    ...
    DESC_PER_WORLD_BYPASS_0(TextColors.GREEN, "Make yourself bypass the per-world {{6}}"),
    DESC_PER_WORLD_BYPASS_1(TextColors.GREEN, "Make yourself stop bypassing the per-world {{6}}"),
    DESC_PER_WORLD_BYPASS_2(TextColors.GREEN, "Make {{6}} bypass the per-world {{6}}"),
    DESC_PER_WORLD_BYPASS_3(TextColors.GREEN, "Make {{6}} stop bypassing the per-world {{6}}"),
    DESC_PER_WORLD_GROUP_0(TextColors.GREEN, "Group {{2}}, {{2}} and {{2}} for per-world {{6}}. It will remove them from any pre-existing groups"),
    DESC_PER_WORLD_GROUP_1(TextColors.GREEN, "Remove {{2}} from any existing group of per-world {{6}}. A world cannot be alone in a group"),
    DESC_PER_WORLD_GROUP_2(TextColors.GREEN, "Group {{2}} and {{2}} for per-world {{6}}. It will remove them from any pre-existing groups"),
    DESC_PER_WORLD_INFORMATION_0(TextColors.GREEN, "Show information about per world {{6}} (state, groups, bypassing players)"),
    DESC_PER_WORLD_INFORMATION_1(TextColors.GREEN, "Show information about per world {{6}} (state, groups, bypassing players)"),
    DESC_PER_WORLD_TOGGLE_0(TextColors.GREEN, "Set per world {{6}} state to {{6}} (activated)"),
    DESC_PER_WORLD_TOGGLE_1(TextColors.GREEN, "Set per world {{6}} state to {{6}} (disabled)"),
    DESC_PER_WORLD_TOGGLE_2(TextColors.GREEN, "Set per world {{6}} state to {{6}} (activated), and save it in config"),
    DESC_PER_WORLD_TOGGLE_3(TextColors.GREEN, "Show current state of per world {{6}}, activated or disabled"),
    DESC_PER_WORLD_TOGGLE_4(TextColors.GREEN, "Show current state of per world {{6}}, activated or disabled, and save it in config"),
    ...
    DESC_PROPERTIES_ENABLE_STRUCTURES_0(TextColors.GREEN, "Enable structures generation on {{2}} by setting property to {{6}}"),
    DESC_PROPERTIES_ENABLE_STRUCTURES_1(TextColors.GREEN, "Disable structures generation on current world by setting property to {{6}}"),
    DESC_PROPERTIES_ENABLE_STRUCTURES_2(TextColors.GREEN, "Show structures generation value of {{2}}"),
    DESC_PROPERTIES_ENABLE_STRUCTURES_3(TextColors.GREEN, "Show structures generation value of current world"),
    ...
    DESC_PROPERTIES_SEED_0(TextColors.GREEN, "Set seed of {{2}} at {{6}}"),
    DESC_PROPERTIES_SEED_1(TextColors.GREEN, "Set seed of current world at {{6}}"),
    DESC_PROPERTIES_SEED_2(TextColors.GREEN, "Show seed of {{2}}"),
    DESC_PROPERTIES_SEED_3(TextColors.GREEN, "Show seed of current world"),
    ...
    // Errors
    BYPASSING_PER_WORLD_LISTENER_START(TextColors.RED, "{{6}} is already bypassing per-world {{6}}"),
    BYPASSING_PER_WORLD_LISTENER_STOP(TextColors.RED, "{{6}} is not bypassing per-world {{6}}"),
    ...
    PER_WORLD_DISABLED(TextColors.RED, "Per world {{6}} management is currently disabled"),
    PER_WORLD_GROUP_EMPTY(TextColors.RED, "You cannot create an empty per-world group"),
    ...
    RESTORING_EXPORTED_WORLD(TextColors.RED, "Impossible to restore {{4}} because the world is not imported. May have been deleted ?"),
    ...
    TAGGING_WORLD_BACKUP(TextColors.RED, "An error occurred while tagging backup for world named {{4}}"),
    ...
    BYPASS_PER_WORLD_COMMAND_BLOCKS(TextColors.GREEN, "Bypassing per-world {{6}} has no effect"),
    BYPASS_PER_WORLD_LISTENER_START(TextColors.GREEN, "{{6}} will now bypass per-world {{6}}"),
    BYPASS_PER_WORLD_LISTENER_STOP(TextColors.GREEN, "{{6}} will not anymore bypass per-world {{6}}"),
    ...
    COMMAND_BLOCKS_GROUP(TextColors.GREEN, "Command blocks of worlds from same group ({{2}}) are {{}} {{6}}"),
    CREATE_WORLD(TextColors.GREEN, "{{2}} has been created successfully"),
    DELETE_WORLD(TextColors.GREEN, "{{2}} has been deleted successfully"),
    ...
    DISABLE_WORLD(TextColors.GREEN, "{{2}} has been disabled successfully"),
    DUPLICATE_WORLD(TextColors.GREEN, "{{2}} has been duplicated as {{6}} successfully"),
    DURATION_TIME(TextColors.GREEN, "(for {{6}} seconds)"),
    ENABLE_TRIGGER(TextColors.GREEN, "Enabled trigger {{6}} for player {{r}}"),
    ENABLE_WORLD(TextColors.GREEN, "{{2}} has been enabled successfully"),
    GAME_MODE(TextColors.GREEN, "{{2}}'s game mode {{}} set to {{6}}"),
    GAME_MODE_GROUP(TextColors.GREEN, "Game mode of worlds from same group ({{2}}) {{}} set to {{6}}"),
    ...
    IMPORT_WORLD(TextColors.GREEN, "{{2}} has been imported successfully"),
    ...
    LOAD_WORLD_START(TextColors.DARK_GRAY,"{{2}} about to be loaded.."),
    LOAD_WORLD(TextColors.GREEN, "{{2}} has been loaded successfully"),
    ...
    RENAME_WORLD(TextColors.GREEN, "{{2}} has been renamed as {{6}} successfully"),
    ...
    SEED(TextColors.GREEN, "{{2}}'s seed {{}} set to {{r}}"),
    SEED_TIP(TextColors.GRAY, "Please reload {{2}} to make this change effective"),
    SPAWN_POSITION(TextColors.GREEN, "{{2}}'s spawn position {{}} placed at {{r}}"),
    STRUCTURES(TextColors.GREEN, "{{2}}'s structures generation is {{}} {{6}}"),
    STRUCTURES_TIP(TextColors.GRAY, "Please reload {{2}} to make this change effective"),
    ...
    UNLOAD_WORLD(TextColors.GREEN, "{{2}} has been unloaded successfully"),
